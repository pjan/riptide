...
from riptide.cli.config import VIDEOS_FILTER_LITERAL
from riptide.cli.utils.download import get_existing_track_filename
from riptide.core.api import ApiError, TidalAPI
from riptide.core.api.models import StreamVideoQuality, Track, TrackQuality, Video
from riptide.core.utils import parse_track_stream, parse_video_stream
from riptide.core.utils.const import (
    TRACK_QUALITY_LITERAL,
    VIDEO_QUALITY_LITERAL,
    track_qualities,
    video_qualities,
)
from riptide.core.utils.ffmpeg import convert_to_mp4, extract_flac
